...
pub fn poem_list() -> Html {
    ...
    let poem_cards:UseStateHandle<Mutex<HashMap<Uuid,PoemProps>>> = use_state(||Mutex::new(HashMap::new()));
        ...
        use_async::<_, (), String>(async move {
            ...
            if let Some(ref data) = resp.data {
                if let Some(poem) = &data.poem {
                    ...
                    poem_map.insert(uuid,PoemProps{
    ...
    let poem_card_html = poem_props.into_iter()
        .map(|prop|html!{
