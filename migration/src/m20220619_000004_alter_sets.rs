...
impl MigrationTrait for Migration {
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        ...
        let table = Table::alter()
            ...
            .add_column(ColumnDef::new(Alias::new("title"))
                .default("")
                .not_null()
                .string())
            .add_column(ColumnDef::new(Alias::new("link"))
                .default("")
                .not_null()
                .string())
            .add_column(
        ...
        let table = Table::alter()
            ...
            .add_column(
                ColumnDef::new(Alias::new("approved"))
                    .default(false)
                    .boolean())
            .add_column(ColumnDef::new(Alias::new("collection_title"))
                .default("")
                .not_null()
                .string())
            .add_column(ColumnDef::new(Alias::new("collection_link"))
                .default("")
                .not_null()
                .string())
