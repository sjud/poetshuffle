...
impl Reducible for EditSetData {
    ...
    fn reduce(self: Rc<Self>, action: Self::Action) -> Rc<Self> {
        match action {
            EditSetDataActions::NewEditFlag(new_edit_flag) => {
                Rc::new(
                    Self{
                        new_edit_flag,
            ...
            EditSetDataActions::PoemUuids(poem_uuids) => {
                Rc::new(
                    Self{
            ...
            EditSetDataActions::EditableSet(editable_set) => {
                Rc::new(
                    Self{
                        new_edit_flag:self.new_edit_flag,
                        poem_list_data:self.poem_list_data.clone(),
            ...
            EditSetDataActions::PoemLoadFlag((uuid,flag)) => {
                Rc::new(
                    Self{
                        new_edit_flag:self.new_edit_flag,
